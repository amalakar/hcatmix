...
hadoop  --config $conf_dir jar $pigperfjar  org.apache.hcatalog.hcatmix.HiveTableCreator -libjars $PWD/lib/sdsuLibJKD12.jar -f scripts/hcat_table_specification.xml -m 1 -o /user/malakar/hcatmix/ 
